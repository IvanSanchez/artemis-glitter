...
// 		
	...
	if (bits.get(7)) { unpacked.unknown1       = data.readFloat();}
	...
	if (bits.get(12)) { unpacked.unknown5       = data.readFloat(); }
	if (bits.get(11)) { unpacked.unknown6       = data.readFloat(); }
	if (bits.get(10)) { unpacked.unknown7       = data.readLong(); }
	if (bits.get(9))  { unpacked.unknown8       = data.readFloat(); }
	if (bits.get(8))  { unpacked.unknown9       = data.readFloat(); }
